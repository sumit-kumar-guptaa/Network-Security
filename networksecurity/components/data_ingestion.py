...
class DataIngestion:
    ...
    def export_data_into_feature_store(self,dataframe: pd.DataFrame):
        try:
            fearture_store_file_path=self.data_ingestion_config.feature_store_file_path
            #createing folder
            dir_path=os.path.dirname(fearture_store_file_path)
            os.makedirs(dir_path,exist_ok=True)
            dataframe.to_csv(fearture_store_file_path,index=False,header=True)
            return dataframe
